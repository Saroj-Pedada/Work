...
function Work() {
  ...
  const fetchWork = async () => {
    try {
      const response = await HttpnInstance.post('/work/getWorks');
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      {varNoData && (<div className="text-center mt-10 text-2xl font-bold tracking-tight text-gray-900">No Work Data</div>)}
